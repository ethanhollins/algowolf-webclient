...
class BrokerSettings extends Component
{
    ...
    async onConnect(e)
    {
        ...
        else if (brokers[broker_id].broker === 'ib')
        {
            ...
            let reqOptions = {
                ...
                credentials: 'include',
                body: JSON.stringify(
                    { broker_id: broker_id, name: brokers[broker_id].name, broker: brokers[broker_id].broker }
                )
            }
    ...
    getAddMode = (selected) =>
    {
        ...
        return (
            ...
            <div className='popup row'>
                <div className='popup title large'>Select Your Broker</div>
            </div>
    ...
    getItems = () =>
    {
        ...
        if (selected in brokers)
        {
            ...
            // else if (mode === 'wait')
            // {
            //     return this.getWaitMode(mode, selected);
            // }
        }
    }
